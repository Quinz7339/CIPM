...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy1.setHeightForWidth(self.btn_CreateDb.sizePolicy().hasHeightForWidth())
        self.btn_CreateDb.setSizePolicy(sizePolicy1)
        ...
        self.btn_CreateDb.setIcon(icon)
        ...
        sizePolicy1.setHeightForWidth(self.btn_OpenDb.sizePolicy().hasHeightForWidth())
        self.btn_OpenDb.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.txtEdit_RecentFiles.sizePolicy().hasHeightForWidth())
        self.txtEdit_RecentFiles.setSizePolicy(sizePolicy2)
